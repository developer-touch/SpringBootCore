...
public class BootIocProj09ProfileSingleYmlFileApplication {

	public static void main(String[] args) {
		//get access IOC container
		ApplicationContext context = SpringApplication.run(BootIocProj09ProfileSingleYmlFileApplication.class, args);
		...
		/*SpringApplication application = new SpringApplication(BootIocProj09ProfileSingleYmlFileApplication.class);
