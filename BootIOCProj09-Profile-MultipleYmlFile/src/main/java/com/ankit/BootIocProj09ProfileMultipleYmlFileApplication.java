...
public class BootIocProj09ProfileMultipleYmlFileApplication {

	public static void main(String[] args) {
		//get access IOC container
		ApplicationContext context = SpringApplication.run(BootIocProj09ProfileMultipleYmlFileApplication.class, args);
